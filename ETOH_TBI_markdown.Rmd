---
title: "ETOH TBI Matched Samples"
...
```{r}
##Cleaning and formatting data prior to matching samples
...
#This line is important because match.it likes numeric data
...
```{r}
##Testing hypotheses using matched data -- do Glasgow Coma Scale (GCS) scores differ by injury type and alcohol content
#Lower GCS scores = worse injury (max possible score = 15, which is perfectly healthy and alert)
...
```{r}
##Simple Main-effects, plus means and standard deviations
